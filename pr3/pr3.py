...
def bar_grapf(df):
    ...
    print('Среднее bmi: ', round(mean1, 1), 'Среднее charges: ', round(mean2, 1))
    print('Мода bmi: ', moda1[0], 'Мода charges: ', moda2[0])
    print('Медиана bmi: ', med1, 'Медиана charges: ', round(med2, 1))
    print('Стандартное отклонение bmi: ', round(std1, 1), 'Стандартное отклонение charges: ', round(std2, 1))
    print('Размах bmi: ', raz1, 'Размах charges: ', round(raz2, 1))
    print('Межквартильный размах bmi: ', round(iqr1, 1), 'Межквартильный размах charges: ', round(iqr2, 1))
